...
export default props => (
    <div>
        <button type="button"   onClick={() => { props.handleEditContact(props.contatoEdit) }} className="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter"><i class="fas fa-trash-alt"></i></button>
